...
class Explainer(object):
	def __init__(self, training_data, predict_fn, n_percentiles = 100, training_labels=None, feature_names=None,
	...
	def explain_instance(self, data_row, labels=(1,),
			...
			predictions = self.predict_fn(neighborhood)
